...
func (x *OtherRequest) Reset() {
	*x = OtherRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pb_math_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*OtherRequest) Descriptor() ([]byte, []int) {
	return file_pb_math_proto_rawDescGZIP(), []int{2}
}

func (x *OtherRequest) GetNumA() float32 {
	if x != nil {
		return x.NumA
	}
	return 0
...
func (x *OtherResponse) Reset() {
	*x = OtherResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pb_math_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *OtherResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*OtherResponse) ProtoMessage() {}

func (x *OtherResponse) ProtoReflect() protoreflect.Message {
	mi := &file_pb_math_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use OtherResponse.ProtoReflect.Descriptor instead.
func (*OtherResponse) Descriptor() ([]byte, []int) {
	return file_pb_math_proto_rawDescGZIP(), []int{3}
}

func (x *OtherResponse) GetData() string {
	if x != nil {
		return x.Data
	}
	return ""
...
var file_pb_math_proto_rawDesc = []byte{
	...
	,
...
var file_pb_math_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_pb_math_proto_goTypes = []interface{}{
	(*MathRequest)(nil),   // 0: MathRequest
	(*MathResponse)(nil),  // 1: MathResponse
	(*OtherRequest)(nil),  // 2: OtherRequest
	(*OtherResponse)(nil), // 3: OtherResponse
}
var file_pb_math_proto_depIdxs = []int32{
	...
	0, // 4: MathService.Cda:input_type -> MathRequest
	1, // 5: MathService.Add:output_type -> MathResponse
	1, // 6: MathService.Subtract:output_type -> MathResponse
	1, // 7: MathService.Multiply:output_type -> MathResponse
	1, // 8: MathService.Divide:output_type -> MathResponse
	1, // 9: MathService.Cda:output_type -> MathResponse
...
func file_pb_math_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_pb_math_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pb_math_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*OtherResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
...
type MathServiceClient interface {
	...
	Cda(ctx context.Context, in *MathRequest, opts ...grpc.CallOption) (*MathResponse, error)
}
...
func (c *mathServiceClient) Cda(ctx context.Context, in *MathRequest, opts ...grpc.CallOption) (*MathResponse, error) {
	out := new(MathResponse)
...
type MathServiceServer interface {
	...
	Cda(context.Context, *MathRequest) (*MathResponse, error)
}
...
func (*UnimplementedMathServiceServer) Cda(context.Context, *MathRequest) (*MathResponse, error) {
