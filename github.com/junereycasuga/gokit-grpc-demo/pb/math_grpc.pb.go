...
type MathServiceClient interface {
	...
	Cda(ctx context.Context, in *OtherRequest, opts ...grpc.CallOption) (*OtherResponse, error)
}
...
func (c *mathServiceClient) Cda(ctx context.Context, in *OtherRequest, opts ...grpc.CallOption) (*OtherResponse, error) {
...
type MathServiceServer interface {
	...
	Cda(context.Context, *OtherRequest) (*OtherResponse, error)
...
func (UnimplementedMathServiceServer) Cda(context.Context, *OtherRequest) (*OtherResponse, error) {
...
func _MathService_Cda_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MathServiceServer).Cda(ctx, req.(*OtherRequest))
	}
	return interceptor(ctx, in, info, handler)
}
